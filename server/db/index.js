...
const getTenantsForUser = exports.getTenantsForUser = async (userId) => {
  try {
    ...
    return users.find(x => (x.username === username && x.password === password)) || null
  } catch (e) {
    _handleAxiosError(e)
    return null
  }
...
const getUserByUsernameAndPassword = exports.getUserByUsernameAndPassword = async (username, password) => {
  try {
