...
const encrypt = (exports.encrypt = x =>
  encodeURIComponent(CryptoJS.AES.encrypt(x, '')))
const decrypt = (exports.decrypt = x =>
  CryptoJS.AES.decrypt(decodeURIComponent(x), '').toString(CryptoJS.enc.Utf8))
