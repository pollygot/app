...
const paramsFromQueryString = (exports.paramsFromQueryString = function(
  queryString
) {
  let result = {}
...
const enrich = (exports.enrich = standardField => {
  ...
  let field = _extends({}, standardField, {
    label: Helpers.toTitleCase(label),
  })
...
const getUniqueSelector = (exports.getUniqueSelector = (
  primaryKeys,
  record
) => {
...
const verifySelectorReturnsUnique = (exports.verifySelectorReturnsUnique = (() => {
  var _ref = _asyncToGenerator(function*(
    ...
    console.log('url', url)
    let { data: proxyResponse } = yield context.$axios
      .get(url)
      .catch(function(e) {
        throw e
      })
...
// must be called from a page or component, passing in the context
const deleteRecord = (exports.deleteRecord = (
  context,
  appId,
  resourceKey,
  selector
...
// must be called from a page or component, passing in the context
const getRecord = (exports.getRecord = (
  context,
  appId,
  resourceKey,
  selector
...
// must be called from a page or component, passing in the context
const updateRecord = (exports.updateRecord = (
  context,
  appId,
  resourceKey,
  selector,
