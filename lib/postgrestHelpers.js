...
export const enrichValues = (standardField) => {
  let field = { ...standardField }
  if (field.format === VALID_FORMATS.DATETIME) field = enrichTimestampField(field)
  if (field.format === VALID_FORMATS.JSON) field = enrichJsonField(field)
  return field
}
